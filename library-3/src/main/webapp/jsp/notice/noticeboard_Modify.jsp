...
<body>
	...
	<div id="cont_wrap">
		<div id="board" style="width: 100%;">
			<form action="noticeboard_ModifyProc" method='post' id="f"
						...
						<tbody>
							...
							<tr>
								...
								<td><input type="text" size="100" id="b_subject"
									...
									value="${board.title }" onfocus="focus_on1(this);"
									onblur="focus_off1(this);" value="" maxlength="100"
									style="width: 70%"> <span class="text1">* 100자리
										이내로 입력해주세요.</span></td>
							</tr>
							...
							<tr>
								...
								<td><textarea name="content" placeholder="내용을 입력하세요."
										style="width: 90%; height: 230px;">${board.content }</textarea>
								</td>
							</tr>
							<tr>
				...
				<div class="board_button2">
					<span><input id="submitbtn" type="button" value="글쓰기"
						onclick="noticemf_Check()" class="cbtn cbtn_point"></span> <span><input
						type="button" value="목록" onclick="location.href='noticeBoard'"
